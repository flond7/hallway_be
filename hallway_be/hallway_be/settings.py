"""
Django settings for hallway_be project.
...
WSGI_APPLICATION = 'hallway_be.wsgi.application'
...
ALLOWED_HOSTS = ['http://127.0.0.1:8000/*','127.0.0.1','localhost','http://localhost:4200']
