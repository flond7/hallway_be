# Generated by Django 4.1 on 2023-03-31 09:31
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('po', models.CharField(default='', max_length=100, verbose_name='Po che fa la richiesta')),
                ...
                ('office', models.CharField(choices=[('o0', '--'), ('o1', 'Informatica'), ('o2', 'Ragioneria'), ('o3', 'Tributi'), ('o4', 'Segreteria'), ('o5', 'Urp'), ('o6', 'Protocollo'), ('o7', 'Messo'), ('o8', 'Polizia locale'), ('o9', 'Anagrafe'), ('o10', 'Manutenzione'), ('o11', 'LLPP'), ('o12', 'Ambiente'), ('o13', 'Commercio'), ('o14', 'Edilizia'), ('o15', 'Biblioteca'), ('o16', 'Informagiovani'), ('o17', 'CDR'), ('o18', 'Politico'), ('o19', 'Contratti')], default='o0', max_length=4, verbose_name='Ufficio principale')),
                ('mail', models.BooleanField(default=False, verbose_name='Mail personale')),
                ('mailOffice', multiselectfield.db.fields.MultiSelectField(choices=[('mo0', '--'), ('mo1', 'manutenzione@'), ('mo2', 'patrimonio@'), ('mo3', 'tecnico@'), ('mo4', 'manutenzione@'), ('mo5', 'tributi@'), ('mo6', 'ragioneria@'), ('mo7', 'informatica@'), ('mo8', 'segreteria@'), ('mo9', 'sindaco@'), ('mo10', 'polizia.locale@'), ('mo11', 'serviziscolastici@'), ('mo12', 'urbanistica@'), ('mo13', 'edilizia.privata@'), ('mo14', 'sportellounico.edilizia@'), ('mo15', 'gestione.territorio@'), ('mo16', 'ambiente@'), ('mo17', 'commercio@'), ('mo18', 'urp@'), ('mo19', 'casa.riposo@'), ('mo20', 'vicesindaco@'), ('mo21', 'anagrafe@'), ('mo21', 'protocollo@')], default='mo0', max_length=100)),
                ('lanOffice', multiselectfield.db.fields.MultiSelectField(blank=True, choices=[('l0', '--'), ('l1', 'Affari Generali'), ('l2', 'Ambiente'), ('l3', 'Anagrafe'), ('l4', 'Associazioni'), ('l5', 'Biblioteca'), ('l6', 'Casa di riposo'), ('l7', 'Commercio'), ('l8', 'Contratti'), ('l9', 'Informagiovani'), ('l10', 'Lavori pubblici'), ('l11', 'Manutenzione'), ('l12', 'Patrimonio'), ('l13', 'Personale'), ('l14', 'Polizia municipale'), ('l15', 'Protocollo'), ('l16', 'Ragioneria'), ('l17', 'Segreteria'), ('l18', 'Segreteria sindaco'), ('l19', 'Servizi educativi'), ('l20', 'Sistemi informatici'), ('l21', 'Tributi'), ('l22', 'Urbanistica')], default='mo0', max_length=100)),
                ('lanRole', models.CharField(blank=True, choices=[('l0', '--'), ('l1', 'Utente'), ('l2', 'Amministratore'), ('l3', 'Solo internet')], default='l1', max_length=2, verbose_name='Ruolo in LAN')),
                ...
                ('adwebRole', models.CharField(blank=True, choices=[('a0', '--'), ('a1', 'Istruttore'), ('a2', 'Istruttore ragioneria'), ('a3', 'Istruttore segreteria'), ('a5', 'Politico'), ('a6', 'Potere di firma')], default='a0', max_length=4, verbose_name='Ruolo in adweb')),
                ...
                ('sdiOffice', multiselectfield.db.fields.MultiSelectField(choices=[('sdi0', '--'), ('sdi1', 'Casa di soggiorno anziani'), ('sdi2', 'Risorse umane 2019'), ('sdi3', 'Polizia locale'), ('sdi4', 'Segreteria generale'), ('sdi5', 'Affari generali urp protocollo'), ('sdi6', 'Contabilità'), ('sdi7', 'Contratti'), ('sdi8', 'Cultura biblioteca'), ('sdi9', 'Personale'), ('sdi10', 'Tributi'), ('sdi11', 'Urbanistica ambiente commercio'), ('sdi12', 'Ufficio centrale'), ('sdi13', 'Manutenzione')], default='sdi0', max_length=100, verbose_name='Ruoli in SDI')),
                ('sdiRole', multiselectfield.db.fields.MultiSelectField(choices=[('sdi0', '--'), ('sdi1', 'FPAVAL - Attive: Valida mette allegati visualizza fatture propria struttura'), ('sdi2', 'FPALETT - Attive: Legge fatture propria struttura'), ('sdi3', 'FPAFIRMA - Attive: Valida mette allegati e convalida fatture intero ente'), ('sdi4', 'FPAGESTLETT - Passive: Visualizza fatture propria struttura'), ('sdi5', 'FPASUPER - Passive: Visualizza fatture intero ente'), ('sdi6', 'FPASUPERA - Passive: Visualizza e porta in contabilità fatture intero ente'), ('sdi7', 'FPASUPERB - Passive: Visualizza porta in contabilità dà esito per fatture intero ente'), ('sdi8', 'FPASUPERC - Passive: Visualizza porta in contabilità dà esito e inoltra per fatture intero ente'), ('sdi9', 'FPAGESTIONE - Passive: Gestisce fatture propria struttura')], default='sdi0', max_length=100, verbose_name='Ruoli in SDI')),
                ('iterattiOffice', multiselectfield.db.fields.MultiSelectField(choices=[('i0', '--'), ('i44', 'POLP  - PO Lavori pubblici'), ('i20', '-- ALPP, Area lavori pubblici e patrimonio'), ('i21', '-- LP, Lavori pubblici'), ('i22', '-- PATRIMONIO, Patrimonio'), ('i23', '-- MAN, Manutenzione'), ('i45', 'POAG  - PO Affari generali'), ('i1', '-- AAG, Area affari generali'), ('i2', '-- PROT, Protocollo'), ('i3', '-- DEL, Delibere'), ('i4', '-- BIBLIO, Biblioteca'), ('i5', '-- PG, Progetto giovani'), ('i6', '-- AANA, Area anagrafe'), ('i7', '-- AN, Anagrafe'), ('i8', '-- ATTIAN, Atti anagrafe'), ('i9', '-- ACA, Area contratti e assicurazioni'), ('i10', '-- URP, Urp'), ('i11', '-- UFFASS, Ufficio assicurazioni'), ('i12', '-- UFFCONT, Ufficio contratti'), ('i13', '-- AAGG, Affari generali'), ('i46', 'PORAG, PO Ragioneria'), ('i14', '-- AEF, Area economico finanziaria'), ('i15', '-- RAG, Ragioneria'), ('i16', '-- ECON, Economo'), ('i17', '-- REVISORI, Revisori'), ('i18', '-- TRIB, Tributi'), ('i19', '-- INF, Informatica'), ('i47', 'POURB, PO Urbanistica'), ('i24', '---AUAP, Area urbanistica e attività produttive'), ('i25', '-- URB, Urbanistica'), ('i26', '-- SUAP, Suap'), ('i27', '-- SUE, Sue'), ('i28', '-- AMB, Ambiente'), ('i29', '-- UFFCOM, Ufficio commercio'), ('i48', 'POVIG, PO Vigili'), ('i30', '-- AMA, Area messo e albo'), ('i31', '-- MESSO, Messo'), ('i32', '-- ALBO, Albo'), ('i33', '-- ATALBO, Atti albo'), ('i33', '-- VIG, Polizia locale'), ('i49', 'POCR, PO Casa di riposo'), ('i34', '-- CR, Casa di riposo'), ('i35', 'UFFSEG - Ufficio segreteria'), ('i36', 'SEG - Segretario'), ('i37', 'SIND - Sindaco'), ('i38', 'GEN  - Protocollo generale'), ('i39', 'BASS\t- Basso Daniele - assessore'), ('i40', 'CREM\t- Cremon Martina - assessore'), ('i41', 'RAGZ - Ragozzino Giuseppe - assessore'), ('i42', 'MEN  - Menegoz Andrea - assessore'), ('i43', 'PORAG  - PO Ragioneria')], default='i0', max_length=100, verbose_name='Uffici iteratti')),
                ...
                ('crmRole', models.CharField(choices=[('c0', '--'), ('c2', 'Inserisce richieste')], default='c0', max_length=2)),
                ...
                ('pmPayRole', models.CharField(choices=[('p0', '--'), ('p1', 'Utente'), ('p2', 'Amministratore')], default='p0', max_length=2)),
                ...
                ('ammTraspRole', models.CharField(choices=[('at0', '--'), ('at1', 'Utente'), ('at2', 'Amministratore')], default='at0', max_length=4)),
                ('osservatorioRole', models.CharField(choices=[('o0', '--'), ('o1', 'Polizia'), ('o2', 'Segretario')], default='o0', max_length=4)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('office', models.CharField(choices=[('o0', '--'), ('o1', 'Informatica'), ('o2', 'Ragioneria'), ('o3', 'Tributi'), ('o4', 'Segreteria'), ('o5', 'Urp'), ('o6', 'Protocollo'), ('o7', 'Messo'), ('o8', 'Polizia locale'), ('o9', 'Anagrafe'), ('o10', 'Manutenzione'), ('o11', 'LLPP'), ('o12', 'Ambiente'), ('o13', 'Commercio'), ('o14', 'Edilizia'), ('o15', 'Biblioteca'), ('o16', 'Informagiovani'), ('o17', 'CDR'), ('o18', 'Politico'), ('o19', 'Contratti')], default='o0', max_length=4, verbose_name='Ufficio principale')),
                ('jobCategory', models.CharField(blank=True, default='', max_length=5, verbose_name='Categoria')),
                ('mail', models.CharField(blank=True, default='@comune.aviano.pn.it', max_length=120, verbose_name='Mail personale')),
                ('mailOffice', multiselectfield.db.fields.MultiSelectField(choices=[('mo0', '--'), ('mo1', 'manutenzione@'), ('mo2', 'patrimonio@'), ('mo3', 'tecnico@'), ('mo4', 'manutenzione@'), ('mo5', 'tributi@'), ('mo6', 'ragioneria@'), ('mo7', 'informatica@'), ('mo8', 'segreteria@'), ('mo9', 'sindaco@'), ('mo10', 'polizia.locale@'), ('mo11', 'serviziscolastici@'), ('mo12', 'urbanistica@'), ('mo13', 'edilizia.privata@'), ('mo14', 'sportellounico.edilizia@'), ('mo15', 'gestione.territorio@'), ('mo16', 'ambiente@'), ('mo17', 'commercio@'), ('mo18', 'urp@'), ('mo19', 'casa.riposo@'), ('mo20', 'vicesindaco@'), ('mo21', 'anagrafe@'), ('mo21', 'protocollo@')], default='mo0', max_length=100)),
                ('lan', models.CharField(blank=True, default='A516-', max_length=120, verbose_name='ID personale')),
                ('lanOffice', multiselectfield.db.fields.MultiSelectField(blank=True, choices=[('l0', '--'), ('l1', 'Affari Generali'), ('l2', 'Ambiente'), ('l3', 'Anagrafe'), ('l4', 'Associazioni'), ('l5', 'Biblioteca'), ('l6', 'Casa di riposo'), ('l7', 'Commercio'), ('l8', 'Contratti'), ('l9', 'Informagiovani'), ('l10', 'Lavori pubblici'), ('l11', 'Manutenzione'), ('l12', 'Patrimonio'), ('l13', 'Personale'), ('l14', 'Polizia municipale'), ('l15', 'Protocollo'), ('l16', 'Ragioneria'), ('l17', 'Segreteria'), ('l18', 'Segreteria sindaco'), ('l19', 'Servizi educativi'), ('l20', 'Sistemi informatici'), ('l21', 'Tributi'), ('l22', 'Urbanistica')], default='mo0', max_length=100)),
                ('lanRole', models.CharField(blank=True, choices=[('l0', '--'), ('l1', 'Utente'), ('l2', 'Amministratore'), ('l3', 'Solo internet')], default='l1', max_length=2, verbose_name='Ruolo in LAN')),
                ...
                ('iterattiDeleted', models.BooleanField(default=False, verbose_name='Iteratti disattivato')),
                ('boxAppsDeleted', models.BooleanField(default=False, verbose_name='Boxapp disattivato')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('mail', models.CharField(choices=[('mo0', '--'), ('mo1', 'manutenzione@'), ('mo2', 'patrimonio@'), ('mo3', 'tecnico@'), ('mo4', 'manutenzione@'), ('mo5', 'tributi@'), ('mo6', 'ragioneria@'), ('mo7', 'informatica@'), ('mo8', 'segreteria@'), ('mo9', 'sindaco@'), ('mo10', 'polizia.locale@'), ('mo11', 'serviziscolastici@'), ('mo12', 'urbanistica@'), ('mo13', 'edilizia.privata@'), ('mo14', 'sportellounico.edilizia@'), ('mo15', 'gestione.territorio@'), ('mo16', 'ambiente@'), ('mo17', 'commercio@'), ('mo18', 'urp@'), ('mo19', 'casa.riposo@'), ('mo20', 'vicesindaco@'), ('mo21', 'anagrafe@'), ('mo21', 'protocollo@')], default='mo0', max_length=4)),
            ],
        ),
        migrations.CreateModel(
            name='officeSDI',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sdiOffices', models.ManyToManyField(to='api_user.officesdi')),
            ],
        ),
        migrations.CreateModel(
            name='userLan',
            fields=[
                ...
                ('lanFolders', models.ManyToManyField(to='api_user.officemail')),
            ],
        ),
    ]
